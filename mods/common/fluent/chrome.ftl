...
label-mouse-control-desc-touch-selection = - Select units by tapping them
label-mouse-control-desc-touch-commands = - Command units by tapping the target
label-mouse-control-desc-touch-dragbox = - Select multiple units by dragging a box
label-mouse-control-desc-touch-longpress = - Deselect and cancel by holding a finger down
label-mouse-control-desc-touch-pan = - Pan the battlefield with two fingers
label-mouse-control-desc-touch-zoom = - Zoom the battlefield by pinching
